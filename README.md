...
| 이진 | Docker 컨테이너화와 Kubernetes 오케스트레이션을 실제 프로젝트에 적용하며 배포 전반의 흐름을 이해할 수 있었습니다. 또한 Jenkins와 ArgoCD를 연동한 CI/CD 파이프라인을 구축하며 수동 배포 과정을 자동화하고 효율적인 운영 환경을 고민해 볼 수 있었습니다. 또한 생소했던 인프라 도구들을 직접 익히고 서비스에 적용해 본 경험은 앞으로 백엔드 개발자로 성장하는 데 의미 있는 기반이 될 것 같습니다.|
